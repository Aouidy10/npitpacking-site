    ...
    <div className="min-h-screen bg-gradient-to-br from-nauma-600 via-nauma-800 to-nauma-900 flex flex-col items-center justify-center px-6 text-white">
      ...
      <div className="text-center mb-10">
        <p className="text-nauma-teal font-semibold tracking-widest text-sm uppercase mb-3">
          NPITPACKING â€” Division NPIT
        </p>
        <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">
          BientÃ´t <span className="text-nauma-teal italic">disponible</span>
        </h1>
        <p className="text-blue-100 text-base md:text-lg max-w-md mx-auto leading-relaxed">
          Notre site est en cours de prÃ©paration. Nous finalisons notre catalogue de produits d&apos;emballage professionnel.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-2xl w-full text-center">
        {[
          { emoji: "ðŸšš", label: "Livraison Maroc" },
          { emoji: "ðŸ“¦", label: "DÃ©tail & Gros" },
          { emoji: "âœ…", label: "QualitÃ© garantie" },
          { emoji: "ðŸ’¬", label: "RÃ©ponse rapide" },
        ].map((a) => (
      ...
      <p className="mt-10 text-white/30 text-xs">Â© 2026 NPITPACKING â€” npitpacking.com</p>
    </div>
  );
}
