  ...
  return (
    <div className="container-main py-14">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-500 text-sm max-w-lg">{t("contact.sub")}</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div>
              <p className="font-semibold text-green-800 group-hover:underline">{t("contact.wa")}</p>
              <p className="text-green-700 text-sm mt-0.5">+212700700585</p>
              <p className="text-green-600 text-xs mt-1">{t("contact.waSub")}</p>
            </div>
          </a>
          ...
          <div className="flex items-start gap-4 bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-0.5">+212700700585</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-0.5">{t("contact.locationVal")} 🇲🇦</p>
          ...
          <div className="flex items-start gap-4 bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-0.5">{t("contact.hoursDays")}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-7">
          {sent ? (
            <div className="flex flex-col items-center justify-center h-full py-12 text-center gap-4">
              ...
              <h3 className="text-lg font-bold text-gray-800">{t("contact.sent")}</h3>
              <button
            ...
            <>
              <h2 className="text-lg font-bold text-gray-800 mb-5">{t("contact.form.title")}</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">{t("contact.form.nom")}</label>
                    <input
                      type="text"
                      required
                      value={form.nom}
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">{t("contact.form.tel")}</label>
                    <input
                      type="tel"
                      required
                      value={form.tel}
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1.5">{t("contact.form.sujet")}</label>
                  <select
                    value={form.sujet}
