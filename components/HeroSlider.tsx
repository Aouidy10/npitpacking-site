...
const SLIDES = [
  {
    ...
    cta: "Voir les films alimentaires",
    href: "/catalogue?cat=emballage-alimentaire&sub=film-alimentaire",
    accent: "#3DAAB5",
  ...
  },
  {
    ...
    cta: "Voir les rouleaux aluminium",
    href: "/catalogue?cat=emballage-alimentaire&sub=rouleau-aluminium",
    accent: "#8a9bb0",
  ...
  },
  {
    ...
    cta: "Voir les barquettes",
    href: "/catalogue?cat=emballage-alimentaire&sub=barquettes-alimentaires",
    accent: "#3DAAB5",
  ...
  },
  {
    ...
    cta: "Voir les gobelets",
    href: "/catalogue?cat=emballage-alimentaire&sub=gobelets-pots",
    accent: "#3DAAB5",
  ...
  },
  {
    ...
    cta: "Voir les sacs",
    href: "/catalogue?cat=plastique&sub=sacs",
    accent: "#C8A46E",
  ...
  },
  {
    ...
    cta: "Voir les pailles",
    href: "/catalogue?cat=emballage-alimentaire&sub=pailles",
    accent: "#3DAAB5",
  ...
  },
  {
    ...
    cta: "Voir les couverts",
    href: "/catalogue?cat=emballage-alimentaire&sub=couverts",
    accent: "#C8A46E",
  ...
  },
  {
    ...
    cta: "Voir les emballages livraison",
